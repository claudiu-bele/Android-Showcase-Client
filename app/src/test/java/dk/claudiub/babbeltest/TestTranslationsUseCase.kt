...
class TestTranslationsUseCase(val gson: Gson, val dispatcherProvider: DispatcherProvider) :
    TranslationsUseCase {
    ...
    override suspend fun getTranslations(): List<TranslatedItem> =
        withContext(dispatcherProvider.io()) {
            ...
            val data: List<TranslatedItem> =
                gson.fromJson(JSON, REVIEW_TYPE) // contains the whole reviews list
            return@withContext data
        }

    companion object {

        /** Couldn't get the file to be loaded from test environment, using this property
         *
         */
        val JSON = """
            [
